...
resource roleAppConfigurationDataOwnerUserAssignedIdentity 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(configurationStore.id, UserAssignedIdentity.id, '5ae67dd6-50cb-40e7-96ff-dc2bfa4b606b') // App Configuration Data Owner
...
resource webAppAppSettings 'Microsoft.Web/sites/config@2025-03-01' = {
  ...
  dependsOn: [
    ...
    roleAppConfigurationDataOwnerUserAssignedIdentity
  ]
}
